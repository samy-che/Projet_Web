...
<head>
    ...
    <title>Time Us - Supprimer un Produit</title>
</head>
        ...
        <section class="products">
            <div class="container">
                <div class="table-container">
                    <h2><i class='bx bx-trash'></i> Supprimer des Produits</h2>
                        ...
                        <tbody>
                            <?php foreach ($produits as $product): ?>
                                <tr>
                                    ...
                                    <td><img src="../img/products/<?= $product['image'] ?>"
                                            alt="<?= htmlspecialchars($product['name']) ?>" style="width:60px;"></td>
                                    <td><?php echo $product['price']; ?>€</td>
                                    <td><?php echo $product['quantity']; ?></td>
                                    <td>
                                        <form method="POST" class="delete-form">
                                            <input type="hidden" name="id" value="<?= $product['id'] ?>">
                                            <button type="submit" class="delete-btn" name="Supprimer"
